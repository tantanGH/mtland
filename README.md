...
内蔵音源・MIDI(LA音源)・MIDI(GS音源)に対応しています。
...
<img src='images/screen8.jpeg' width='800px'/>

ゲームを起動すると、音源選択メニューになります。内蔵音源、MIDI(LA音源)、MIDI(GS音源)のいずれかを選択してください。MIDIボードの有無は特にチェックしていないので、RS-MIDIも利用可能です。レバーやパッド方向キーで選択し、ボタンを押すと決定になります。

音源選択後、初期コースを選択してください。
...
5ラップするとゴールでリザルトが表示されます。4コースすべて走り終わると総合ポイントが表示され、ゲーム終了となります。
